...
def Init_DCO():
    ...
    global C0, F0 , pvt_lsb , acq_lsb , trk_i_lsb , trk_f_lsb , FREQ_RES_PVT , FREQ_RES_ACQ , FREQ_RES_TRK , FREQ_RES_TRK_F
...
f_desired = 2045e6#FCW * FREF  # F0  # desired frequency
...
################################################################################################################
    ...
    plt.figure()
    plt.plot(freqs[1:500], '-r', label="DCO")
    ...
    marker = 3.5e6  # Substitua pelo valor específico de frequência desejado
    ...
    plt.scatter(marker, marker_dB, color='black', marker='o', label=f'{marker_dB:.2f} dBc/Hz  @3.5 MHz')
