...
if __name__ == "__main__":
    ...
    plt.xlabel(label1, fontsize=8)
    plt.ylabel(label2, fontsize=8)
    plt.grid(visible=True)
    plt.savefig(r'C:\Users\ander\OneDrive\Área de Trabalho\artigo\f_out.eps', bbox_inches='tight',format='eps')
    # plt.show()
    ##################################################################################
    ...
    plt.grid(visible=True)
    SaveCsvValues("OTW_ACQ_1.csv",x=OTW[1:600], y=np.arange(1, 600, 1))
    # plt.show()
