...
\begin{quadro}[htb]
	\caption{Estado da arte de sintetizadores em tecnologia CMOS 65nm}
	\label{qd:others_works}
	\resizebox{\columnwidth}{!}{%
		\begin{tabular}{|c|c|c|c|c|c|}
			\hline
			& \textbf{\cite{chen2021529}} & \textbf{\cite{Liu2018ADPLL}} & \textbf{\cite{liu2019265}} & \textbf{\cite{ji20172}} & \textbf{\cite{lee2017design}} \\ \hline
