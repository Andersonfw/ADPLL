...
%é essencial garantir que a infraestrutura de comunicação seja capaz de lidar com a demanda crescente e oferecer desempenho otimizado em termos de velocidade, confiabilidade e eficiência energética
%
%A revolução da internet transformou radicalmente a sociedade, alterando fundamentalmente a forma como as pessoas vivem, interagem e consomem informações. No entanto, essa revolução está longe de terminar. Com o surgimento da Internet das Coisas (IoT), espera-se uma nova onda de transformação, conectando ainda mais a vida cotidiana das pessoas à internet, segundo \cite{al2020internet} IoT será a próxima revolução industrial, com a projeção de que até 2030 o número de dispositivos conectados em todo o mundo alcance a marca impressionante de 500 bilhões, de acordo com dados da \cite{Cisco2020}.
%
%Dispositivos Iot são caracterizados pela ampla cobertura, baixo consumo de energia e alta eficiência energética, o que os permite uma longa vida útil operando com bateria. 
%
%
